...
#         # создать сет на основе первого списка
#         # пройтись по второму списку, проверить есть ли в сете число
#         # если есть - удалить из сета - занести в список
#         set1 = set(nums1)
#         result = []
#         for x in nums2:
...
# 14. ☠️ 350. Intersection of Two Arrays II
...
#         # создать хэш мапу (элементы: кол-во) по первому списку
#         # пройтись по второму списку, проверяя есть ли число в хэш мапе
#         # если есть уменьшать счетчик
#
#         # 1) c = Counter(nums1)
#         # 2) c = {}.fromkeys(nums1, 0)
#         # 3)
#         c = {}
#         for i in nums1:
#             if i in c:
#                 c[i] += 1 # или так: c[i] = c.get(i, 0) + 1
#             else:
#                 c[i] = 1
#
#         result = []
